...
class RegisterScreen extends StatelessWidget {
  ...
  final TextEditingController referredByCodeController = TextEditingController();
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        controller: referredByCodeController,
                        decoration: InputDecoration(
                          labelText: 'Referred By Code (optional)',
                        ),
                      ),
                      SizedBox(height: 10),
                      Row(
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          final referredByCode = referredByCodeController.text;
                          ...
                          if (isRegistered) {
                            ...
                            Get.toNamed('/login'); // Redirect to login after successful registration
                          } else {
